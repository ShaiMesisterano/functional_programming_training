...
var ex15 = compose(chain(safeGet('name')), chain(safeGet('street')), safeGet('address'));

console.log(Maybe('Walnut St'), ex15(user))
...
console.log("http://127.0.0.1:51135/index.html", runIO(ex2()));

// Exercise 3
// ==========
// Use monads to first get the Post with getPost(), then pass it's id in to getComments().
console.log("--------Start exercise 3--------")
var ex3 = compose(chain(getComments), getPost)
